...
export const R32_STRUCTURE: { matchNumber: number; teamA: R32Slot; teamB: R32Slot }[] = [
  ...
  { matchNumber: 81, teamA: { kind: "winner",   group: "G" },                 teamB: { kind: "best3rd", candidates: ["A","E","H","I","J"] } },
  { matchNumber: 82, teamA: { kind: "winner",   group: "D" },                 teamB: { kind: "best3rd", candidates: ["B","E","F","I","J"] } },
