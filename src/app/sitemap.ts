...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = ["", "/cities", "/stadiums", "/stadiums/compare", "/schedule", "/schedule/friendlies", "/predictor", "/tickets", "/tickets/affordability", "/kits", "/how-to-watch", "/faq", "/blog", "/groups", "/globe", "/about", "/contact", "/privacy", "/terms", "/affiliate-disclosure"].map(
    (path) => ({
      url: `${SITE}${path || "/"}`,
      lastModified,
